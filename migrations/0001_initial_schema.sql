-- Migration number: 0001 	YYYY-MM-DDTHH:MM:SS.SSSZ
-- Migrating D1 database midnightmarketnews: initial application schema
-- Source: local SQLite schema from midnight-society.db / src/database/database.js
